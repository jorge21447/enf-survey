              ...
              <table className=" w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  {users?.length > 0 ? (
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center mr-3">
                            <img
                              src={user?.photo_profile ? user.photo_profile : UserDefault}
                              alt="profile photo"
                    ...
                    <tr>
                      <td colSpan="5" className="px-4 py-6 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center" >
                        No hay usuarios.
                      </td>
                    </tr>
                  )}
